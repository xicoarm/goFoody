...
<form method="post" action="overview">
    ...
    <div class="mm4" style="">
        ...
        <div class="mm4-column">
            <select required name="s1"id="s1" onchange="picturemChickenm2('texts1', 'imgs1','s1')" class="btn btn-info" required>
    ...
    <div class="mm4" style="">
        ...
        <div class="mm4-column">
            <select required name="s2"id="s2" onchange="picturemChickenm2('texts2', 'imgs2','s2')" class="btn btn-info" required>
                <option disabled value="" selected="selected">Gericht 2</option>
    ...
    <div class="mm4" style="">
        ...
        <div class="mm4-column">
            <select required name="s3"id="s3" onchange="picturemChickenm2('texts3', 'imgs3','s3')" class="btn btn-info" required>
                <option disabled value="" selected="selected">Gericht 2</option>
    ...
    <div class="mm4" style="">
        ...
        <div class="mm4-column">
            <select required name="s4"id="s4" onchange="picturemChickenm2('texts4', 'imgs4','s4')" class="btn btn-info" required>
                <option disabled value="" selected="selected">Gericht 2</option>
    ...
    <div class="mm4" style="">
        ...
        <div class="mm4-column">
            <select required name="s5"id="s5" onchange="picturemChickenm2('texts5', 'imgs5','s5')" class="btn btn-info" required>
                <option disabled value="" selected="selected">Gericht 2</option>
