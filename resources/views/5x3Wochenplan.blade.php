...
<form method="post" action="overview">
    ...
    <div class="mm4" style="">
        ...
        <div class="mm4-column">
            <select required name="s1"id="s1" onchange="picturemChickenm2('texts1', 'imgs1','s1','{{$_POST['mealsize']}}')" class="btn btn-info" required>
            ...
            <div>
                <img id="imgs1" src='' style="display:block;margin:auto;width: 150px;display:none;border-radius: 30%;"/>
            </div>

            <div    class="textm1">

                <div>
                    <h3 id="texts1" style="display: initial" class="textm1" > </h3>
                </div>
            </div>
        ...
        <div class="mm4-column">
            <select required name="a1" id="a1" onchange="picturemChickenm2('texta1', 'imga1','a1','{{$_POST['mealsize']}}')" class="btn btn-info" required>
                <option disabled value="" selected="selected">Gericht 3</option>
    ...
    <div class="mm4" style="">
        ...
        <div class="mm4-column">
            <select required name="s2"id="s2" onchange="picturemChickenm2('texts2', 'imgs2','s2','{{$_POST['mealsize']}}')" class="btn btn-info" required>
                <option disabled value="" selected="selected">Gericht 2</option>
            ...
            <div>
                <img id="imgs2" src='' style="display:block;margin:auto;width: 150px;display:none;border-radius: 30%;"/>
            </div>

            <div    class="textm1">

                <div>
                    <h3 id="texts2" style="display: initial" class="textm1" > </h3>
                </div>
            </div>
    ...
    <div class="mm4" style="">
        ...
        <div class="mm4-column">
            <select required name="s3"id="s3" onchange="picturemChickenm2('texts3', 'imgs3','s3','{{$_POST['mealsize']}}')" class="btn btn-info" required>
                <option disabled value="" selected="selected">Gericht 2</option>
            ...
            <div>
                <img id="imgs3" src='' style="display:block;margin:auto;width: 150px;display:none;border-radius: 30%;"/>
            </div>

            <div    class="textm1">

                <div>
                    <h3 id="texts3" style="display: initial" class="textm1" > </h3>
                </div>
            </div>
    ...
    <div class="mm4" style="">
        ...
        <div class="mm4-column">
            <select required name="s4"id="s4" onchange="picturemChickenm2('texts4', 'imgs4','s4','{{$_POST['mealsize']}}')" class="btn btn-info" required>
                <option disabled value="" selected="selected">Gericht 2</option>
            ...
            <div>
                <img id="imgs4" src='' style="display:block;margin:auto;width: 150px;display:none;border-radius: 30%;"/>
            </div>

            <div    class="textm1">

                <div>
                    <h3 id="texts4" style="display: initial" class="textm1" > </h3>
                </div>
            </div>
    ...
    <div class="mm4" style="">
        ...
        <div class="mm4-column">
            <select required name="s5"id="s5" onchange="picturemChickenm2('texts5', 'imgs5','s5','{{$_POST['mealsize']}}')" class="btn btn-info" required>
                <option disabled value="" selected="selected">Gericht 2</option>
            ...
            <div>
                <img id="imgs5" src='' style="display:block;margin:auto;width: 150px;display:none;border-radius: 30%;"/>
            </div>

            <div    class="textm1">

                <div>
                    <h3 id="texts5" style="display: initial" class="textm1" > </h3>
                </div>
            </div>
